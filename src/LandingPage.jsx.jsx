  ...
  return (
    <div ref={rootRef} className="bc-landing">
      ...
      <div className="bc-wrap">
            ...
            {PLANS_LANDING.map((p) => (
              <div key={p.id} className={`bc-plan-card ${p.populaire ? "populaire" : ""}`}>
                ...
                <button
                  ...
                  onClick={onEntrer}
                >
                  {p.id === "entreprise" ? "Nous contacter" : "Commencer"}
                </button>
              </div>
            ))}
          </div>
        ...
        <section className="bc-section" id="cgu" style={{ maxWidth: 720 }}>
          <div className="bc-section-head">
            <h2 className="display">Conditions d'utilisation</h2>
            <p style={{ fontStyle: "italic" }}>
              Document en cours d'élaboration, à faire valider par un professionnel du droit avant
              d'être considéré comme définitif. Il décrit néanmoins fidèlement le fonctionnement
              réel du service à ce jour.
            </p>
          </div>
          <div style={{ display: "grid", gap: "1rem", fontSize: 14, lineHeight: 1.7, color: "var(--ink)" }}>
            <p>
              BossClever est un service édité par Clever Entreprises (Cocody Riviera Faya,
              Abidjan, Côte d'Ivoire), destiné aux entreprises souhaitant évaluer objectivement la
              performance de leurs employés.
            </p>
            <p>
              <strong>Comptes et accès.</strong> Un compte "manager" donne accès à la gestion
              d'une entreprise (employés, critères, validations). Un compte "employé" est créé par
              l'entreprise et donne accès à un espace personnel limité à ses propres données. Un
              manager principal peut inviter jusqu'à 3 co-administrateurs, avec des permissions
              qu'il définit lui-même.
            </p>
            <p>
              <strong>Abonnement et paiement.</strong> BossClever propose un palier gratuit et des
              paliers payants facturés mensuellement. Les paiements sont traités par le
              prestataire tiers CinetPay ; Clever Entreprises ne stocke aucune donnée de carte
              bancaire ou de compte Mobile Money.
            </p>
            <p>
              <strong>Utilisation raisonnable.</strong> Le service ne doit pas être utilisé pour
              collecter des données sur des personnes n'ayant pas le statut d'employé de
              l'entreprise concernée, ni à des fins de surveillance abusive.
            </p>
            <p>
              <strong>Résiliation.</strong> Un compte manager peut être fermé à tout moment sur
              demande auprès de contact@cleverentreprises.com.
            </p>
          </div>
        </section>

        <section className="bc-section" id="confidentialite" style={{ maxWidth: 720 }}>
          <div className="bc-section-head">
            <h2 className="display">Politique de confidentialité</h2>
            <p style={{ fontStyle: "italic" }}>
              Document en cours d'élaboration, à faire valider par un professionnel du droit avant
              d'être considéré comme définitif. Il décrit néanmoins fidèlement le fonctionnement
              réel du service à ce jour.
          ...
          <div style={{ display: "grid", gap: "1rem", fontSize: 14, lineHeight: 1.7, color: "var(--ink)" }}>
            <p>
              <strong>Données collectées.</strong> Nom, email et département de chaque employé ;
              tâches assignées et déclarées ; scores de performance et critères associés ;
              rapports journaliers ; notes anonymes entre collègues. Si l'entreprise active le
              pointage géolocalisé, la position GPS est utilisée au moment du pointage pour
              vérifier la proximité du lieu de travail, sans suivi continu de localisation.
            </p>
            <p>
              <strong>Finalité.</strong> Ces données servent uniquement au calcul du score de
              performance, au suivi des tâches et à la gestion interne de l'entreprise cliente.
              Elles ne sont ni vendues ni partagées avec des tiers à des fins publicitaires.
            </p>
            <p>
              <strong>Hébergement.</strong> Les données sont hébergées via Supabase. Les paiements
              sont traités par CinetPay, qui applique sa propre politique de confidentialité pour
              les données de paiement.
            </p>
            <p>
              <strong>Cookies.</strong> BossClever utilise uniquement des cookies techniques
              nécessaires au maintien de la session de connexion. Aucun cookie publicitaire ou de
              suivi tiers n'est utilisé à ce jour.
            </p>
            <p>
              <strong>Vos droits.</strong> Toute personne peut demander l'accès, la correction ou
              la suppression de ses données en écrivant à{" "}
              <a href="mailto:contact@cleverentreprises.com">contact@cleverentreprises.com</a>.
            </p>
          </div>
        </section>
