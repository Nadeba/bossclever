...
// Révèle son contenu (fondu + léger glissement) la première fois qu'il
// entre dans le viewport en scrollant — jamais au chargement initial pour
// le contenu déjà visible, pour ne pas faire clignoter la page.
...
// Un chiffre qui s'anime en comptant jusqu'à sa valeur finale, une seule
// fois, quand il devient visible à l'écran.
function CompteurAnime({ cible, suffixe = "", duree = 1200 }) {
  const ref = useRef(null);
  ...
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && !demarre) {
          setDemarre(true);
          observer.disconnect();
        }
      },
  ...
  useEffect(() => {
    ...
    const tick = (maintenant) => {
      ...
      setValeur(Math.round(progres * cible));
...
const PHRASES_BANDEAU = [
  "Score transparent sur 100",
  "14 critères pondérables",
  "Pointage géolocalisé",
  "Contestation possible",
  "Co-administrateurs à permissions",
  "Multi-sites avec géorepérage propre",
  "Archives par mois, trimestre, année",
  "Alertes avant que le problème n'éclate",
];

function BandeauDefilant() {
  const contenu = [...PHRASES_BANDEAU, ...PHRASES_BANDEAU];
  return (
    <div className="bc-ticker">
      <div className="bc-ticker-track">
        {contenu.map((p, i) => (
          <span key={i} className="bc-ticker-item">
            {p} <span className="bc-ticker-dot">●</span>
          </span>
        ))}
      </div>
    </div>
    ...
    <div ref={rootRef} className="bc-landing">
      <style>{`
        ...
        .bc-hero-photo {
          ...
          border-radius: 20px;
          display: block;
          box-shadow: 0 24px 50px -22px rgba(15, 79, 168, 0.4);
        }
        @media (max-width: 900px) {
          .bc-hero-photo { min-height: 280px; }
        }
        .bc-eyebrow {
          display: inline-flex;
          align-items: center;
        ...
        .bc-ticker-track {
          display: flex;
          width: max-content;
          animation: bc-scroll 28s linear infinite;
        }
        @keyframes bc-scroll {
        ...
        .bc-ticker-dot { color: var(--yellow); font-size: 8px; }
        @media (prefers-reduced-motion: reduce) {
        ...
        .bc-compteur-link:hover {
          background: #EEF5FF;
          transform: translateY(-2px);
        }
        @media (max-width: 760px) {
          .bc-compteurs { grid-template-columns: repeat(2, 1fr); gap: 28px; }
        }
        ...
        .bc-equipe-texte h2 { margin: 0 0 14px; }
        .bc-equipe-texte p { font-size: 15px; color: var(--muted); line-height: 1.6; margin: 0 0 10px; }
        @media (max-width: 760px) {
          .bc-equipe-band { grid-template-columns: 1fr; }
        }
        ...
        .bc-step-link { text-decoration: none; color: inherit; }
        .bc-step-link h3 { transition: color 0.15s ease; }
        .bc-step-link:hover h3 { color: var(--blue); }
        .bc-step-more {
        ...
        .bc-step-more:hover { text-decoration: underline; }
      ...
      <div className="bc-wrap">
        ...
        <header className="bc-hero">
          ...
          <img
            src="/images/equipe-strategie.jpg"
            alt="Une équipe passe en revue sa stratégie d'entreprise au bureau, avec des graphiques et un tableau de bord"
            className="bc-hero-photo"
          />
        </header>
      </div>
      ...
      <div className="bc-wrap">
        <section className="bc-section" style={{ borderTop: "none" }}>
          <Reveal>
            <div className="bc-equipe-band">
              <Ledger />
              <div className="bc-equipe-texte">
                <h2 className="display">Des décisions sur des faits, pas sur des impressions</h2>
                <p>
                  Chaque manager qui pilote son équipe avec BossClever s'appuie sur les mêmes
                  données que celles que voient ses employés — un score transparent, un journal
                  de points, des rapports qui racontent vraiment ce qui s'est passé.
                </p>
                <p>
                  Pas de feuille Excel recomposée en fin de mois, pas de jugement à l'instinct :
                  juste ce que le terrain a réellement produit.
                </p>
              </div>
            </div>
          </Reveal>
        ...
        <section className="bc-section" id="piliers">
        ...
        <section className="bc-section">
          <Reveal>
            <div className="bc-compteurs">
              <a href="#14-criteres" className="bc-compteur-link">
                <div className="bc-compteur-nombre">
                  <CompteurAnime cible={14} />
                </div>
                <p className="bc-compteur-label">critères de notation</p>
              </a>
              <a href="#calcul-score" className="bc-compteur-link">
                <div className="bc-compteur-nombre">
                  <CompteurAnime cible={100} />
                </div>
                <p className="bc-compteur-label">score sur 100, transparent</p>
              </a>
              <a href="#six-piliers" className="bc-compteur-link">
                <div className="bc-compteur-nombre">
                  <CompteurAnime cible={6} />
                </div>
                <p className="bc-compteur-label">piliers de suivi</p>
              </a>
              <a href="#co-administrateurs" className="bc-compteur-link">
                <div className="bc-compteur-nombre">
                  <CompteurAnime cible={3} />
                </div>
                <p className="bc-compteur-label">co-administrateurs max</p>
              </a>
            </div>
          </Reveal>
        </section>
        ...
        >
          ...
          <div className="bc-steps">
            <div className="bc-step">
              ...
              <a href="#regles-manager" className="bc-step-link">
              ...
              <a href="#regles-manager" className="bc-step-more">
                En savoir plus →
              </a>
            </div>
            <div className="bc-step">
              <div className="bc-step-num">02</div>
              <a href="#declaration-validation" className="bc-step-link">
              ...
              <a href="#declaration-validation" className="bc-step-more">
                En savoir plus →
              </a>
            </div>
            <div className="bc-step">
              <div className="bc-step-num">03</div>
              <a href="#calcul-score" className="bc-step-link">
              ...
              <a href="#calcul-score" className="bc-step-more">
                En savoir plus →
              </a>
            </div>
          </div>
        ...
        <section className="bc-section" id="tarifs">
          <div className="bc-section-head">
            <h2 className="display">Des tarifs simples, pensés pour grandir</h2>
            <p>
              Commencez gratuitement, passez à un palier supérieur quand votre équipe grandit —
              en Afrique ou ailleurs. Aucune carte bancaire requise pour démarrer.
            </p>
          </div>
          <Reveal>
        ...
        <section
          className="bc-section"
          id="criteres"
          style={{ background: "#FFF9E6", borderRadius: 20, padding: "2.5rem 2rem" }}
        >
          <div className="bc-section-head">
