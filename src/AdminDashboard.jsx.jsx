...
function KPIGrid({ nombreEntreprises }) {
  return (
      ...
      {kpis.map((item) => (
        <div className="bc-kpi" key={item.title}>
          ...
          <div className="bc-kpi-main">
            ...
            <strong>
              {item.title === "Entreprises" ? nombreEntreprises : item.value}
            </strong>
            <small
...
function OverviewPage({ nombreEntreprises }) {
  return (
    <>
      <KPIGrid nombreEntreprises={nombreEntreprises} />
    ...
    <div className="bc-admin-app">
      ...
      <main className="bc-content">
        ...
        <div className="bc-page">
          {active === "overview" ? (
            <OverviewPage nombreEntreprises={nombreEntreprises} />
          ) : (
            <PlaceholderPage
              title={activeItem.label}
