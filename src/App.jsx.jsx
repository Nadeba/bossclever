...
export default function App() {
  ...
  useEffect(() => {
    ...
    sauvegarderDansSupabase(session.access_token, rowId, { employes, criteres, logoUrl, bureau, plan, heureArrivee, heureDepart, journalActivite, sites }).catch(() => {});
  }, [employes, criteres, logoUrl, bureau, plan, heureArrivee, heureDepart, journalActivite, sites, chargement, session, rowId]);
