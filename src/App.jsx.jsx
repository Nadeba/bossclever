  ...
  const presenceAujourdhui = useMemo(
    () =>
      employes.map((e) => {
        ...
        return { ...e, arrivee, depart, enRetard };
      }),
    [employes, heureArrivee]
  );
                ...
                {presentsAujourdhui.map((e) => (
                  <Card key={e.id} style={{ padding: "10px 16px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      {e.depart ? (
                        <Badge tone="neutral">Départ {e.depart}</Badge>
                      ) : (
          ...
          <>
            ...
            {estPrincipal && (
              <div>
                ...
                <p style={{ margin: "0 0 12px", fontSize: 13, color: "#5F5E5A" }}>
                  Sert à déterminer automatiquement les retards dans l'onglet "Présence".
                </p>
...
export default function App() {
  ...
  useEffect(() => {
    ...
    sauvegarderDansSupabase(session.access_token, rowId, { employes, criteres, logoUrl, bureau, plan, heureArrivee }).catch(() => {});
  }, [employes, criteres, logoUrl, bureau, plan, heureArrivee, chargement, session, rowId]);
