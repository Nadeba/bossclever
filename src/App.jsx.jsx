...
function LigneRapportLecture({ heure, principal, secondaire, badge, tone }) {
  return (
    ...
    >
      <span style={{ color: "#5F5E5A", width: 50 }}>{heure || "—"}</span>
      <span style={{ flex: 1 }}>
        {principal}
        {secondaire && <span style={{ color: "#5F5E5A" }}> — {secondaire}</span>}
      </span>
...
function RapportsJournaliersManager({ employes, evaluerRapport }) {
      ...
      <Card style={{ display: "grid", gap: 16 }}>
        ...
        {rapport && (
          <>
            ...
            <div>
              <p style={{ margin: "0 0 8px", fontSize: 13, fontWeight: 500 }}>Planning prévu</p>
            ...
            <div>
              ...
              {rapport.realise.length === 0 ? (
                <p style={{ margin: 0, fontSize: 13, color: "#5F5E5A" }}>Rien de déclaré.</p>
              ) : (
                <div style={{ display: "grid", gap: 6 }}>
...
function VueManager({
  ...
  return (
    <div style={{ display: "grid", gap: 24 }}>
      ...
      <RapportsJournaliersManager employes={employes} evaluerRapport={evaluerRapport} />
...
function RapportJournalierEmploye({
  ...
  return (
    <div>
      <h3 style={{ fontSize: 15, fontWeight: 500, margin: "0 0 4px", textTransform: "capitalize" }}>
        ...
        <div>
          ...
          <div style={{ display: "grid", gap: 6, marginBottom: 10 }}>
            {rapport.planning.map((l) => (
              ...
              >
                <span style={{ color: "#5F5E5A", width: 50 }}>{l.heure || "—"}</span>
                <span style={{ flex: 1 }}>
                  {l.tache}
