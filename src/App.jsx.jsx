...
export default function App() {
  ...
  useEffect(() => {
    ...
    sauvegarderDansSupabase(session.access_token, rowId, { employes, criteres, logoUrl, bureau, bureaux, plan, abonnement, heureArrivee, heureDepart, journalActivite, sites, nomEntreprise, adresseEntreprise }).catch(() => {});
  }, [employes, criteres, logoUrl, bureau, bureaux, plan, abonnement, heureArrivee, heureDepart, journalActivite, sites, nomEntreprise, adresseEntreprise, chargement, session, rowId]);
