...
export default function App() {
  ...
  useEffect(() => {
    ...
    sauvegarderDansSupabase(session.access_token, rowId, { employes, criteres, logoUrl, bureau, plan, heureArrivee, heureDepart, journalActivite }).catch(() => {});
  }, [employes, criteres, logoUrl, bureau, plan, heureArrivee, heureDepart, journalActivite, chargement, session, rowId]);
